...
explain when—and when not—graph denoising helps. We hope the audit, and the
...
\url{https://github.com/One-bit-007/graph-cold}, and will be archived on Zenodo
with a persistent DOI upon acceptance.
